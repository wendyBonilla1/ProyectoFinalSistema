...
public class Producto extends javax.swing.JFrame {
    ...
    String[] cols = {"Codigo", "Nombre", "Precio", "Cantidad"};
    String[][] data = {};
    ...
    private void initComponents() {
        ...
        TxtcantidadProducto = new rojeru_san.RSMTextFull();
        ...
        TxtphoneProveedor.setPlaceholder("Precio");

        TxtcantidadProducto.setForeground(new java.awt.Color(103, 71, 206));
        TxtcantidadProducto.setBordeColorFocus(new java.awt.Color(103, 71, 206));
        TxtcantidadProducto.setBotonColor(new java.awt.Color(103, 71, 206));
        TxtcantidadProducto.setPlaceholder("Cantidad");
        ...
        TxtnameProveedor.setPlaceholder("Producto");
    ...
    private void materialButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialButton1ActionPerformed
        ...
        if (!TxtcantidadProducto.getText().matches("[0-9]+")) {
            JOptionPane.showMessageDialog(this, "¡La cantidad solo es dato numerico!");
            return;
        }
        if (!TxtphoneProveedor.getText().matches("[0-9]+")) {
            JOptionPane.showMessageDialog(this, "¡El precio solo es dato numerico!");
            return;
        }

        model.addRow(new Object[]{UUID.randomUUID().toString(), TxtnameProveedor.getText(),  TxtphoneProveedor.getText(), TxtcantidadProducto.getText()});
    ...
    private void JtableProovedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JtableProovedorMouseClicked
        ...
        TxtphoneProveedor.setText(model.getValueAt(i, 2).toString());
        TxtcantidadProducto.setText(model.getValueAt(i, 3).toString());
    ...
    private void materialButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialButton3ActionPerformed
        ...
        if (i >= 0) {
            ...
            model.setValueAt(TxtphoneProveedor.getText(), i, 2);
            model.setValueAt(TxtcantidadProducto.getText(), i, 3);
        } else {
    ...
    public rojeru_san.RSMTextFull TxtcantidadProducto;
